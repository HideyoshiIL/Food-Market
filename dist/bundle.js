...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
  ...
  const slidPrev = document.querySelector(prevArrow),
    slider = document.querySelector(container),
    slidNext = document.querySelector(nextArrow),
...
`;
  ...
  slidNext.addEventListener("click", () => {
    ...
    dots[indSlide - 1].style.opacity = 1;
  })
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])(".timer", '2026-06-11');
